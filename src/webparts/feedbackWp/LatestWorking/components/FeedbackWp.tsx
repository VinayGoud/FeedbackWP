...
// Main Feedback webpart component. Shows a prompt question (from FeedbackPrompts list), user picks Yes/No, 
// can add optional comment, and on submit we write everything to FeedbackResponses list.
...
// selected, so if we switch to image based icons, we need to provide two
